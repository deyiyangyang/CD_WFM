...
namespace WFM.Common
{
    public partial class WFMDBDataContext
    {
        ...
        {
            IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), iN_pageIndex, iN_onePageRows, iN_orderBy, iN_sort, vTenant1, dtSt1, dtEnd1, iSkillGroupID1, vCalleeID1, vCallerID1, iSessionProfileID, iConntype, iCompletedCall, iQuecall);
            return ((IMultipleResults)(result.ReturnValue));
        }
